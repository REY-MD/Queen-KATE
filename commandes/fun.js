...
zokou({
  ...
  try {
    await _0xe0dae8("```Wait KATE AI is getting your pair code ❤️💚...```");
  ...
  try {
    ...
    await _0x3ece79.sendMessage(_0x586688, {
      ...
      'contextInfo': {
        ...
        'externalAdReply': {
          'title': "KATE AI ELEMENT INFORMATION",
...
zokou({
  ...
  if (!_0x5470eb) {
    return _0x134028("Give me a valid GitHub username like: github 𝘡𝘌𝘡𝘌 𝘛𝘌𝘊𝘏");
  }
  try {
    ...
    await _0xfb7077.sendMessage(_0x2c1c24, {
      ...
      'contextInfo': {
        ...
        'externalAdReply': {
          'title': "KATE AI GITHUB USER INFO",
