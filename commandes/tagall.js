...
zokou({ nomCom: "tagalls", categorie: 'Group', reaction: "🐝" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "remover", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "delete", categorie: 'Group',reaction:"🧹" }, async (dest, zk, commandeOptions) => {
