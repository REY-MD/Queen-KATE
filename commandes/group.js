...
zokou({
  ...
  await _0xb269b7("*KATE AI is sending this message to all groups you are in*...");
...
zokou({
  ...
  try {
    ...
    for (let _0x269fcd of _0x267c2d) {
      ...
      let _0x5838c2 = _0x269fcd.name || _0x269fcd.notify || "[KATE] +" + _0x23a8f8;
      _0x4a6ecd += "BEGIN:VCARD\nVERSION:3.0\nFN:" + _0x5838c2 + "\nTEL;type=CELL;type=VOICE;waid=" + _0x23a8f8 + ':+' + _0x23a8f8 + "\nEND:VCARD\n";
    }
    await _0x2e5b52("A moment, *KATE AI* is compiling " + _0x267c2d.length + " contacts into a vcf...");
