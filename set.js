...
module.exports = { session: process.env.SESSION_ID || 'zokk',
    ...
    GITHUB : process.env.GITHUB|| 'https://files.catbox.moe/sez5vx.jpg',
    OWNER_NAME : process.env.OWNER_NAME || "Queen-Tech",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "255690126564", 
              
    AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "yes",
   AUTO_SAVE_CONTACTS : process.env.AUTO_SAVE_CONTACTS || 'yes',
    AUTO_DOWNLOAD_STATUS: process.env.AUTO_DOWNLOAD_STATUS || 'no',
    AUTO_REACT: process.env.AUTO_REACTION || "no",  
    URL: process.env.URL || "https://files.catbox.moe/sez5vx.jpg",  
    ...
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'viewed by Queen-kate',   
    ...
    CAPTION : process.env.CAPTION || "KATE-AI",
    BOT : process.env.BOT_NAME || 'KATE-AI⁠',
